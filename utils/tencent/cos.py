...
def upload_file(bucket, region, file_object, key):
    ...
    # 方式二：基于腾讯文档说明的api--get_object_url回去
    return get_url(client, bucket, key)
...
def delete_bucket(bucket, region):
    ...
    try:
        # 找到文件 & 删除
        while True:
            part_objects = client.list_objects(bucket)  # 一次最多返回1000个，所以外面加了while true
